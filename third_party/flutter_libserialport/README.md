> Vendored copy of flutter_libserialport 0.6.0 with the Android platform
> removed: its android/build.gradle uses jcenter(), which current Gradle no
> longer supports, and the app only uses serial ports on desktop.
